    ...
    _createClass(LunarHelp, [
        ...
        },
        {
            ...
            value: function getLunarDay() {
                return cMonth(parseInt(this.month)) + cDay(parseInt(this.day));
            }
        },
        {
            //获得阴历日期某一天的中文
    ...
    _createClass(SimpleCalendar, [
        ...
        },
        {
            ...
            value: function create() {
                ...
                var $day = $("#calendar").attr('data-day', this.tday);
            }
        },
        {
            //刷新日历
            ...
            value: function update() {
                ...
                if($(".schedule-container").is("#"+$schedule_id))
                {
                    ...
                    $schedule_container = $("#"+$schedule_id);
                ...
                else
                {
                    ...
                    var $result = getMonthSchedule(year,month);
                    var $html = $result.data.html;

                    var $schedule_container = $("#schedule-container-clone").clone();
                    $schedule_container.attr("id", $schedule_id);
                    $schedule_container.removeClass("_none");
                    $schedule_container.html($html);

                    $("#schedule-container-clone").before($schedule_container);
...
SimpleCalendar.timeupdate = function () {
    ...
    [].forEach.call(timespan, function (v) {
        v.innerHTML = '<i class="fa fa-clock-o"></i> ' + nh + ":" + nm + ':' + ns;
    });
};
//国际化，和一些节日数据，标记数据
