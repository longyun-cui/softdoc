!function(){
    ...
    var o={
        ...
        t=function(){ $(".js-backtotop").on("click", function(o){ o.preventDefault(),
...
a=function(){
$(".header-burger-menu").on("click",
function(o){
o.preventDefault(),
$("body").hasClass("show")?($(".header-burger-menu").removeClass("active"),
$("body").removeClass("show")):($(".header-burger-menu").addClass("active"),
$("body").addClass("show"))}),
$(window).width()>991?($("body").removeClass("probootstrap-mobile-menu-active"),
$(".header-burger-menu").removeClass("active")):$("body").addClass("probootstrap-mobile-menu-active"),
$(window).resize(function(){
$(window).width()>991?(console.log("resizing"),
$("body").removeClass("probootstrap-mobile-menu-active"),
$(".header-burger-menu").removeClass("active")):$("body").addClass("probootstrap-mobile-menu-active")}),
$(document).click(function(o){var t=$(".probootstrap-nav,.header-burger-menu");
t.is(o.target)||0!==t.has(o.target).length||$("body").hasClass("show")&&($("body").removeClass("show"),
$(".header-burger-menu").removeClass("active"))})},
n=function(){$(".js-probootstrap-search").on("click",
function(){
$("#probootstrap-search").addClass("active"),
setTimeout(function(){
$("#probootstrap-search").find("#search").focus().select()}, 500)}),
$(".js-probootstrap-close").on("click",
function(){
...
$(".popup-youtube,.popup-vimeo,.popup-gmaps").magnificPopup({disableOn:700, type:"iframe", mainClass:"mfp-fade", removalDelay:160, preloader:!1,fixedContentPos:!1})}, u=function(){o.any()||$(window).stellar()}, m=function(){$(".progress-bar-s2").length>0&&($(".progress-bar-s2").appear(), $(document.body).on("appear", ".progress-bar-s2", function(){
var o=$(this);
