    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="row" style="margin:16px 0;">
                <h3 class="pull-left"><b>内容结构图</b></h3>
            ...
            <div class="row" style="margin:32px 0;">
                <button type="button" class="btn btn-flat btn-success show-create-content"><i class="fa fa-plus"></i> 添加新内容</button>
                <a href="{{ url('/item/'.$data->id) }}" target="_blank"><button type="button" class="btn btn-flat btn-primary">预览</button></a>
                <button type="button" onclick="history.go(-1);" class="btn btn-flat btn-default">返回</button>
            </div>
        </div>
        <!-- END PORTLET-->
    </div>
...
<div class="row" style="margin-top:16px;background:#fff;">
    <div class="col-md-12">
        <!-- BEGIN PORTLET-->
        <div class="box form-container">

            <div class="row" style="margin:16px 0;">
                <h3 class="pull-left"><b>添加/编辑内容</b></h3>
            </div>
