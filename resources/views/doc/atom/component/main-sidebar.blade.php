    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu tree"data-widget="tree">
            ...
            <li class="treeview {{ $sidebar_item_all_list_active or '' }} ">
                <a href="{{ url('/atom/item/item-all-list') }}">
