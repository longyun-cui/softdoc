...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_DOC_ATOM').'component.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_DOC_ATOM').'component.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_DOC_ATOM').'component.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_DOC_ATOM').'component.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_DOC_ATOM').'component.control-sidebar')
