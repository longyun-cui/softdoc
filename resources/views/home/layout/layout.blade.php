...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('home.component.main-header')

    {{--main-sidebar--}}
    @include('home.component.main-sidebar')

    {{--main-content--}}
    @include('home.component.main-content')

    {{--main-footer--}}
    @include('home.component.main-footer')

    {{--control-sidebar--}}
    @include('home.component.control-sidebar')
