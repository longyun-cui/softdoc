...
class User extends Authenticatable
{
    ...
    function parent()
    {
        return $this->belongsTo('App\Models\Doc\Doc_User','parent_id','id');
    }

    // 名下代理商
    function children()
    {
        return $this->hasMany('App\Models\Doc\Doc_User','parent_id','id');
    }
    ...
    function pivot_item()
    {
        return $this->belongsToMany('App\Models\Doc\Doc_Item','pivot_user_item','user_id','item_id')
    ...
    function pivot_user()
    {
        return $this->belongsToMany('App\Models\Doc\K_User','pivot_user_user','user_1_id','user_2_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\Doc\Doc_User','pivot_user_relation','mine_user_id','relation_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\Doc\Doc_User','pivot_user_relation','relation_user_id','mine_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
